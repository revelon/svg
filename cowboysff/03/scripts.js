...
/* ************************************************************************* */
    ...
    function disableInnoBonus(whichOne, byGun){
        ...
        if (byGun){
            ...
            else AudioMan.play("catbirdcatbird");AudioMan.play("catbird");
...
/*
        var ani2 = document.createElementNS(svgns, 'animateTransform');
...
*/
    ...
    function abeceda(evt){
        ...
        while (letter < abc.length){
            ...
            lettSpan.setAttributeNS(null, "x", x+12);
    ...
    getHighScore = function(playerName) {
      var tmpAdr = "cowboys_score.txt" + ((playerName) ? ("?name="+playerName+"&score="+score) : "");
...
window.setTimeout("AudioMan.play('gun_fire_enemy')", 3300);
window.setTimeout("AudioMan.play('gun_fire_enemy')", 4800);
window.setTimeout("AudioMan.play('gun_fire_enemy')", 6000);
