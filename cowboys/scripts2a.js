...
/* ************************************************************************* */
    ...
    function bandit (id, type){
        ...
        addDynamicAnimation(this.currAnimPicture);
        ...
        addDynamicAnimation(this.currAnim);
        ...
        for (var i=0; i<bandits.length; i++){
            if ( bandits[i].id==id ){
                ...
                // positive one
                    ...
                    addDynamicAnimation(bandits[i].currAnim);
                    bandits[i].currAnim.beginElement();
                    addDynamicAnimation(bandits[i].currAnimPicture);
                    bandits[i].currAnimPicture.beginElement();
