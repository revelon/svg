...
/* ************************************************************************* */
    ...
    function ini(evt){
        ...
        realTarget = document.getElementById("theMiddle");
        healthMask = document.getElementById("healthMask");
    ...
    function DoMouseDown(evt, emulate){
        ...
        if ((btn==0) && (bullets>0)){
            ...
            for (var i=0; i<innocents.length; i++){
                if(innocents[i]['living'] && collisionBB(document.getElementById(innocents[i]['name']+'Act'))){
